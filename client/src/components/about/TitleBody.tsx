...
export function TitleBody({
  ...
  return (
    <div className='w-full px-4 py-14 xs:px-4 xs:py-14 md:px-10 md:py-14 lg:px-40 lg:py-[84px] xl:px-[240px] bg-white flex flex-col justify-start items-start gap-[20px] md:gap-[10px] lg:gap-[24px] overflow-hidden xs:overflow-visible md:overflow-hidden lg:overflow-hidden'>
      <div className='self-stretch flex flex-col xs:flex-col md:flex-row lg:flex-row justify-between gap-4 xs:gap-4 md:gap-20 lg:gap-52'>
        ...
        <div className='w-full md:max-w-[424px] lg:max-w-[645px] text-neutral-800 text-[17px] lg:text-[18px] font-normal xs:font-normal md:font-medium lg:font-medium leading-7 xs:leading-7 md:leading-relaxed lg:leading-relaxed'>
          {text}
        </div>
      </div>
    </div>
